            ...
            <div className={"col-span-3 md:col-span-2 group flex justify-center relative items-center flex-col"}>
                ...
                <div
                    ...
                    <button onClick={() => setDisplay("opacity-0 invisible top-10")}
                            className={"text-zinc-400 hover:rotate-[360deg] transition-all duration-700 text-2xl absolute right-3 top-5"}>
                ...
                <div
                    className={"w-8 h-28 md:group-hover:opacity-100 duration-500 transition-all opacity-0  group-hover:top-5  flex-col flex justify-between text-white absolute top-7 right-5"}>
                    <button
                        className={"text-white hover:text-[#ca8f65] group relative transition-all duration-300"}>
                        <span
                            className={"w-16 h-6 text-[16px] bg-zinc-700  hidden  absolute right-12 text-white"}>add</span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                    ...
                    <button className={"text-white hover:text-[#ca8f65] transition-all duration-300"}>
                        {!favourite &&
                    ...
                    <button
                        ...
                        className={"text-white hover:text-[#ca8f65] transition-all duration-300"}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5"
                             stroke="currentColor" className="w-5 h-5">
                            <path strokeLinecap="round" strokeLinejoin="round"
